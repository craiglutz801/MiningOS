...
def init_db() -> None:
    ...
    for name in ["001_init.sql", "002_minerals_and_focus.sql", "003_update_minerals_to_six.sql", "004_areas_state_claim_type.sql", "005_discovery_prompts.sql", "006_discovery_runs.sql", "007_discovery_runs_locations.sql", "008_targets_plss_unique.sql"]:
